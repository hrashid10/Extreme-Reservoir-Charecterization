...
function plot_model_comparison(bhp_true, bhp_pred_data, bhp_pred_phys,
    ...
    axs[2,3].set_title("Physics-informed − Data driven")
...
# casedata
casename="Trained and Evaluated on bulk distribution"
num_mon  = 200
λ_cov   = 100.0
@BSON.load "Evaluation_BBB.bson" bhp_true bhp_pred_data bhp_pred_phys K_true K_pred_data K_pred_phys
bhp_true_BBB, bhp_pred_data_BBB, bhp_pred_phys_BBB, K_true_BBB, K_pred_data_BBB, K_pred_phys_BBB=bhp_true, bhp_pred_data, bhp_pred_phys, K_true, K_pred_data, K_pred_phys


@BSON.load "Evaluation_BBS.bson" bhp_true bhp_pred_data bhp_pred_phys K_true K_pred_data K_pred_phys
bhp_true_BBS, bhp_pred_data_BBS, bhp_pred_phys_BBS, K_true_BBS, K_pred_data_BBS, K_pred_phys_BBS=bhp_true, bhp_pred_data, bhp_pred_phys, K_true, K_pred_data, K_pred_phys


@BSON.load "Evaluation_BSB.bson" bhp_true bhp_pred_data bhp_pred_phys K_true K_pred_data K_pred_phys
bhp_true_BSB, bhp_pred_data_BSB, bhp_pred_phys_BSB, K_true_BSB, K_pred_data_BSB, K_pred_phys_BSB=bhp_true, bhp_pred_data, bhp_pred_phys, K_true, K_pred_data, K_pred_phys


@BSON.load "Evaluation_BSS.bson" bhp_true bhp_pred_data bhp_pred_phys K_true K_pred_data K_pred_phys
bhp_true_BSS, bhp_pred_data_BSS, bhp_pred_phys_BSS, K_true_BSS, K_pred_data_BSS, K_pred_phys_BSS=bhp_true, bhp_pred_data, bhp_pred_phys, K_true, K_pred_data, K_pred_phys


@BSON.load "Evaluation_SBB.bson" bhp_true bhp_pred_data bhp_pred_phys K_true K_pred_data K_pred_phys
bhp_true_SBB, bhp_pred_data_SBB, bhp_pred_phys_SBB, K_true_SBB, K_pred_data_SBB, K_pred_phys_SBB=bhp_true, bhp_pred_data, bhp_pred_phys, K_true, K_pred_data, K_pred_phys


@BSON.load "Evaluation_SBS.bson" bhp_true bhp_pred_data bhp_pred_phys K_true K_pred_data K_pred_phys
bhp_true_SBS, bhp_pred_data_SBS, bhp_pred_phys_SBS, K_true_SBS, K_pred_data_SBS, K_pred_phys_SBS=bhp_true, bhp_pred_data, bhp_pred_phys, K_true, K_pred_data, K_pred_phys


@BSON.load "Evaluation_SSB.bson" bhp_true bhp_pred_data bhp_pred_phys K_true K_pred_data K_pred_phys
bhp_true_SSB, bhp_pred_data_SSB, bhp_pred_phys_SSB, K_true_SSB, K_pred_data_SSB, K_pred_phys_SSB=bhp_true, bhp_pred_data, bhp_pred_phys, K_true, K_pred_data, K_pred_phys


@BSON.load "Evaluation_SSS.bson" bhp_true bhp_pred_data bhp_pred_phys K_true K_pred_data K_pred_phys
bhp_true_SSS, bhp_pred_data_SSS, bhp_pred_phys_SSS, K_true_SSS, K_pred_data_SSS, K_pred_phys_SSS=bhp_true, bhp_pred_data, bhp_pred_phys, K_true, K_pred_data, K_pred_phys




rmse_data_bbb = rmse_per_sample(bhp_pred_data_BBB, bhp_true_BBB)
rmse_phys_bbb  = rmse_per_sample(bhp_pred_phys_BBB, bhp_true_BBB)
rmse_data_bbs = rmse_per_sample(bhp_pred_data_BBS, bhp_true_BBS)
rmse_phys_bbs  = rmse_per_sample(bhp_pred_phys_BBS, bhp_true_BBS)
rmse_data_bsb = rmse_per_sample(bhp_pred_data_BSB, bhp_true_BSB)
rmse_phys_bsb  = rmse_per_sample(bhp_pred_phys_BSB, bhp_true_BSB)
rmse_data_bss = rmse_per_sample(bhp_pred_data_BSS, bhp_true_BSS)
rmse_phys_bss  = rmse_per_sample(bhp_pred_phys_BSS, bhp_true_BSS)



rmse_data_sbb = rmse_per_sample(bhp_pred_data_SBB, bhp_true_SBB)
rmse_phys_sbb  = rmse_per_sample(bhp_pred_phys_SBB, bhp_true_SBB)
rmse_data_sbs = rmse_per_sample(bhp_pred_data_SBS, bhp_true_SBS)
rmse_phys_sbs  = rmse_per_sample(bhp_pred_phys_SBS, bhp_true_SBS)
rmse_data_ssb = rmse_per_sample(bhp_pred_data_SSB, bhp_true_SSB)
rmse_phys_ssb  = rmse_per_sample(bhp_pred_phys_SSB, bhp_true_SSB)
rmse_data_sss = rmse_per_sample(bhp_pred_data_SSS, bhp_true_SSS)
rmse_phys_sss  = rmse_per_sample(bhp_pred_phys_SSS, bhp_true_SSS)


fig, axs = subplots(constrained_layout=true, figsize=(12,5))

axL = axs
bp=axL.boxplot([ rmse_data_sbb, rmse_phys_sbb, rmse_data_sbs , rmse_phys_sbs, rmse_data_ssb , rmse_phys_ssb,rmse_data_sss , rmse_phys_sss ];
                positions=[1.0,1.5, 2.5,3, 4,4.5, 5.5,6], widths=0.2,
                showfliers=false, patch_artist=true, labels=[ "SLL\nDD", "SLL\nPI", "SLS\nDD", "SLS\nPI", "SSL\nDD", "SSL\nPI", "SSS\nDD", "SSS\nPI"] )
...
colors = ["#ff7f0e", "#1f77b4", "#ff7f0e", "#1f77b4", "#ff7f0e", "#1f77b4", "#ff7f0e", "#1f77b4"]
...
rmse_data_bbb = rel_l2_per_sample(K_pred_data_BBB, K_true_BBB)
rmse_phys_bbb  = rel_l2_per_sample(K_pred_phys_BBB, K_true_BBB)
rmse_data_bbs = rel_l2_per_sample(K_pred_data_BBS, K_true_BBS)
rmse_phys_bbs  = rel_l2_per_sample(K_pred_phys_BBS, K_true_BBS)
rmse_data_bsb = rel_l2_per_sample(K_pred_data_BSB, K_true_BSB)
rmse_phys_bsb  = rel_l2_per_sample(K_pred_phys_BSB, K_true_BSB)
rmse_data_bss = rel_l2_per_sample(K_pred_data_BSS, K_true_BSS)
rmse_phys_bss  = rel_l2_per_sample(K_pred_phys_BSS, K_true_BSS)



rmse_data_sbb = rel_l2_per_sample(K_pred_data_SBB, K_true_SBB)
rmse_phys_sbb  = rel_l2_per_sample(K_pred_phys_SBB, K_true_SBB)
rmse_data_sbs = rel_l2_per_sample(K_pred_data_SBS, K_true_SBS)
rmse_phys_sbs  = rel_l2_per_sample(K_pred_phys_SBS, K_true_SBS)
rmse_data_ssb = rel_l2_per_sample(K_pred_data_SSB, K_true_SSB)
rmse_phys_ssb  = rel_l2_per_sample(K_pred_phys_SSB, K_true_SSB)
rmse_data_sss = rel_l2_per_sample(K_pred_data_SSS, K_true_SSS)
rmse_phys_sss  = rel_l2_per_sample(K_pred_phys_SSS, K_true_SSS)
...
# axL.set_title("MSE (left) & Perm error (right)")
axL.set_ylabel("Perm relative L2 norm, m\$^2\$", fontsize=16)
...
# num_mon   = 50
# λ_cov   = 100.0
# @BSON.load "ModelPhysicsBSBv2.bson" model
# modelDPFEHM=model
# @BSON.load "ModelDataBSBv2.bson" model
# modelDATA=model
...
# num_mon = 200
# λ_cov   = 100.0
# @BSON.load "ModelPhysicsSBBv2.bson" model
# modelDPFEHM=model
# @BSON.load "ModelDataSBBv2.bson" model
# modelDATA=model

# casename="SBS"
# num_mon = 200
# λ_cov   = 10.0
# @BSON.load "ModelPhysicsSBSv2.bson" model
# modelDPFEHM=model
# @BSON.load "ModelDataSBSv2.bson" model
# modelDATA=model

# casename="SSB"
# num_mon = 50
# λ_cov   = 100.0
# @BSON.load "ModelPhysicsSSBv2.bson" model
# modelDPFEHM=model
# @BSON.load "ModelDataSSBv2.bson" model
# modelDATA=model
...
# xrand=1234 # fixed for plotting(1234)
# for i in 1:N_val
#     Random.seed!(xrand+i)
