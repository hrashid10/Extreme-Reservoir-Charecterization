...
@BSON.load "Evaluation_TBeRE.bson" bhp_true bhp_pred_data bhp_pred_phys K_true K_pred_data K_pred_phys
bhp_true_TBeRE, bhp_pred_data_TBeRE, bhp_pred_phys_TBeRE, K_true_TBeRE, K_pred_data_TBeRE, K_pred_phys_TBeRE=bhp_true, bhp_pred_data, bhp_pred_phys, K_true, K_pred_data, K_pred_phys

@BSON.load "Evaluation_TBnREeRE.bson" bhp_true bhp_pred_data bhp_pred_phys K_true K_pred_data K_pred_phys
bhp_true_TBnREeRE, bhp_pred_data_TBnREeRE, bhp_pred_phys_TBnREeRE, K_true_TBnREeRE, K_pred_data_TBnREeRE, K_pred_phys_TBnREeRE=bhp_true, bhp_pred_data, bhp_pred_phys, K_true, K_pred_data, K_pred_phys

@BSON.load "Evaluation_TBnREeB.bson" bhp_true bhp_pred_data bhp_pred_phys K_true K_pred_data K_pred_phys
bhp_true_TBnREeB, bhp_pred_data_TBnREeB, bhp_pred_phys_TBnREeB, K_true_TBnREeB, K_pred_data_TBnREeB, K_pred_phys_TBnREeB=bhp_true, bhp_pred_data, bhp_pred_phys, K_true, K_pred_data, K_pred_phys

@BSON.load "Evaluation_TREeRE.bson" bhp_true bhp_pred_data bhp_pred_phys K_true K_pred_data K_pred_phys
bhp_true_TREeRE, bhp_pred_data_TREeRE, bhp_pred_phys_TREeRE, K_true_TREeRE, K_pred_data_TREeRE, K_pred_phys_TREeRE=bhp_true, bhp_pred_data, bhp_pred_phys, K_true, K_pred_data, K_pred_phys
...
rmse_data_TBeRE = rmse_per_sample(bhp_pred_data_TBeRE, bhp_true_TBeRE)
rmse_phys_TBeRE  = rmse_per_sample(bhp_pred_phys_TBeRE, bhp_true_TBeRE)

rmse_data_TBnREeRE = rmse_per_sample(bhp_pred_data_TBnREeRE, bhp_true_TBnREeRE)
rmse_phys_TBnREeRE  = rmse_per_sample(bhp_pred_phys_TBnREeRE, bhp_true_TBnREeRE)

rmse_data_TBnREeB = rmse_per_sample(bhp_pred_data_TBnREeB, bhp_true_TBnREeB)
rmse_phys_TBnREeB  = rmse_per_sample(bhp_pred_phys_TBnREeB, bhp_true_TBnREeB)

rmse_data_TREeRE = rmse_per_sample(bhp_pred_data_TREeRE, bhp_true_TREeRE)
rmse_phys_TREeRE  = rmse_per_sample(bhp_pred_phys_TREeRE, bhp_true_TREeRE)
...
axL = axs
bp=axL.boxplot([rmse_data_bbb, rmse_phys_bbb, rmse_data_TBeRE , rmse_phys_TBeRE, rmse_data_TBnREeRE , rmse_phys_TBnREeRE, rmse_data_TREeRE , rmse_phys_TREeRE];
                positions=[1,1.5, 2.5,3, 4,4.5, 5.5,6], widths=0.2,
                showfliers=false, patch_artist=true, labels=["tBeB\nDD", "tBeB\nPI", "tBeR\nDD", "tBeR\nPI", "tBnReR\nDD", "tBnReR\nPI","tReR \nDD", "tReR \nPI"] )
...
display(fig)
fig.savefig("PressureOverallre.pdf")
println()
PyPlot.close(fig)
...
K_data_bbb = rel_l2_per_sample(K_pred_data_BBB, K_true_BBB)
K_phys_bbb  = rel_l2_per_sample(K_pred_phys_BBB, K_true_BBB)

K_data_TBeRE = rel_l2_per_sample(K_pred_data_TBeRE, K_true_TBeRE)
K_phys_TBeRE  = rel_l2_per_sample(K_pred_phys_TBeRE, K_true_TBeRE)

K_data_TBnREeRE = rel_l2_per_sample(K_pred_data_TBnREeRE, K_true_TBnREeRE)
K_phys_TBnREeRE  = rel_l2_per_sample(K_pred_phys_TBnREeRE, K_true_TBnREeRE)

K_data_TBnREeB = rel_l2_per_sample(K_pred_data_TBnREeB, K_true_TBnREeB)
K_phys_TBnREeB  = rel_l2_per_sample(K_pred_phys_TBnREeB, K_true_TBnREeB)

K_data_TREeRE = rel_l2_per_sample(K_pred_data_TREeRE, K_true_TREeRE)
K_phys_TREeRE  = rel_l2_per_sample(K_pred_phys_TREeRE, K_true_TREeRE)
...
axL = axs
bp=axL.boxplot([K_data_bbb, K_phys_bbb, K_data_TBeRE , K_phys_TBeRE, K_data_TBnREeRE , K_phys_TBnREeRE,K_data_TREeRE , K_phys_TREeRE];
                positions=[1,2, 4,5, 7,8, 10,11], widths=0.2,
                showfliers=false, patch_artist=true, labels=["tBeB\nDD", "tBeB\nPI", "tBeR\nDD", "tBeR\nPI", "tBnReR\nDD", "tBnReR\nPI", "tReR \nDD", "tReR \nPI"] )
