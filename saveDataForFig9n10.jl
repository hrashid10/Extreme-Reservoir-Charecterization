...
# num_mon  = 200
# λ_cov   = 10.0
# @BSON.load "ModelPhysicsBBSv2n10.bson" model
# modelDPFEHM=model
# @BSON.load "ModelDataBBSv2n10.bson" model
# modelDATA=model

# casename="BSB"
# num_mon   = 50
# λ_cov   = 100.0
# @BSON.load "ModelPhysicsBSBv2n10.bson" model
# modelDPFEHM=model
# @BSON.load "ModelDataBSBv2n10.bson" model
# modelDATA=model

# casename="BSS"
# num_mon = 50
# λ_cov   = 10.0
# @BSON.load "ModelPhysicsBSSv2n10.bson" model
# modelDPFEHM=model
# @BSON.load "ModelDataBSSv2n10.bson" model
# modelDATA=model

# casename="SBB"
# num_mon = 200
# λ_cov   = 100.0
# @BSON.load "ModelPhysicsSBBv2n10.bson" model
# modelDPFEHM=model
# @BSON.load "ModelDataSBBv2n10.bson" model
# modelDATA=model

# casename="SBS"
# num_mon = 200
# λ_cov   = 10.0
# @BSON.load "ModelPhysicsSBSv2n10.bson" model
# modelDPFEHM=model
# @BSON.load "ModelDataSBSv2n10.bson" model
# modelDATA=model

# casename="SSB"
# num_mon = 50
# λ_cov   = 100.0
# @BSON.load "ModelPhysicsSSBv2n10.bson" model
# modelDPFEHM=model
# @BSON.load "ModelDataSSBv2n10.bson" model
# modelDATA=model
...
num_mon = 50
λ_cov   = 10.0
@BSON.load "ModelPhysicsSSSv2n10.bson" model
modelDPFEHM=model
@BSON.load "ModelDataSSSv2n10.bson" model
modelDATA=model
