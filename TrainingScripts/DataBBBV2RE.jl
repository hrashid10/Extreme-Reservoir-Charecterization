...
for i in 1:N_train
    ...
    @inbounds begin
        train_bhps_bulk[:,  i] = Float32.(bhp_vec)
...
train_bhps  = hcat(train_bhps_bulk,  train_bhps_rare)
train_coeff = hcat(train_coeff_bulk, train_coeff_rare)


N_train=size(train_bhps,2)
@show N_train
val_bhps  = h_mon_tail[:,5001:5200]
val_coeff = x_tail[:,5001:5200]
...
BSON.@save "DataBBBv2REn10.bson" train_losses val_losses bhp_losses perm_losses
BSON.@save "ModelDataBBBv2REn10.bson" model 
